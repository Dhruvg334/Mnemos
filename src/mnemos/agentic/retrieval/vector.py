...
class VectorRetriever:
    ...
    async def search(
        ...
        select("evidence_regions.id", "evidence_regions.text_excerpt", "evidence_regions.metadata", "documents.id").select_from("evidence_regions").join("documents", "evidence_regions.document_id = documents.id")
